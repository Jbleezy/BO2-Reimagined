...
CoD.Zombie.GAMETYPE_ZCONTAIN = "zcontain"
...
CoD.Zombie.GameTypeGroups[CoD.Zombie.GAMETYPE_ZCONTAIN] = {}
CoD.Zombie.GameTypeGroups[CoD.Zombie.GAMETYPE_ZCONTAIN].maxPlayers = 8
CoD.Zombie.GameTypeGroups[CoD.Zombie.GAMETYPE_ZCONTAIN].minPlayers = 2
CoD.Zombie.GameTypeGroups[CoD.Zombie.GAMETYPE_ZCONTAIN].maxLocalPlayers = 2
CoD.Zombie.GameTypeGroups[CoD.Zombie.GAMETYPE_ZCONTAIN].maxLocalSplitScreenPlayers = 4
CoD.Zombie.GameTypeGroups[CoD.Zombie.GAMETYPE_ZCONTAIN].maxTeamPlayers = 4
CoD.Zombie.GameTypeGroups[CoD.Zombie.GAMETYPE_ZCONTAIN].minTeamPlayers = 1
