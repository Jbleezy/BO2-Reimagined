...
* Fixed weapon slot order changing when purchasing a melee wallbuy or grabbing a Max Ammo powerup after throwing the Time Bomb
...
* Can no longer switch weapons while deploying
* Switches back to correct weapon after deploying
