...
main()
{
	...
	replaceFunc(maps\mp\zombies\_zm_spawner::zombie_spawn_init, scripts\zm\replaced\_zm_spawner::zombie_spawn_init);
...
precache_strings()
{
	...
	precacheString(&"objective_update_enemy_player_nearby");
