...
main()
{
	...
	replaceFunc(maps\mp\zm_transit::precache_team_characters, scripts\zm\replaced\zm_transit::precache_team_characters);
	replaceFunc(maps\mp\zm_transit::give_team_characters, scripts\zm\replaced\zm_transit::give_team_characters);
	...
	replaceFunc(maps\mp\zombies\_zm_equip_electrictrap::zap_zombie, scripts\zm\replaced\_zm_equip_electrictrap::zap_zombie);
