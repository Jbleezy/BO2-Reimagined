...
grief_score_hud()
{
	...
	level.grief_hud.team["axis"].score["axis"].x -= 22.5;
	...
	level.grief_hud.team["axis"].score["allies"].x += 22.5;
	...
	level.grief_hud.team["allies"].score["axis"].x += 22.5;
	...
	level.grief_hud.team["allies"].score["allies"].x -= 22.5;
